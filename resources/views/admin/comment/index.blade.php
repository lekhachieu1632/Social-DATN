                                        ...
                                        @if(isset($data ) && count($data))
                                            ...
                                            @foreach($data  as $key )
                                                <tr class=" @if( $i++ / \App\Setting\Setting_Static::STATIC_TWO == 0)  even @else odd @endif">
                                                    ...
                                                    <td>{{ isset($key['post']['content']) && $key['post']['content']?$key['post']['content']: ""}}</td>
                                                    <td>{{$key['content']}}</td>
                                                    ...
                                                    <td class="">
                                                        ...
                                                        <button type="button" class="btn btn-block bg-gradient-danger btn-md ">
                                                            <a class="bg-gradient-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" href="{{route("comment-delete",['id' => $key['id']])}}"><i class="fas fa-trash-alt"></i></a>
                                                        </button>
